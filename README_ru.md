...
Если Вы знаете какой-либо иностранный язык и хотите помочь нам или просто заметили неточность в переводе, сделать это просто — https://www.transifex.com/projects/p/pozitone/.
