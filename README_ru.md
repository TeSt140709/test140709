...
Начиная с версии 35 (Chrome), Вы можете сделать так, чтобы быстрые клавиши работали даже тогда, когда браузер не на переднем плане: см. [шаги 1-7](#set-up--change-keyboards-shortcuts) выше, измените «В Chrome» на «Глобальные» на шаге 6.
